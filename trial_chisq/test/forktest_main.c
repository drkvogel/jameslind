...
int main(int argc, char **argv, char *envp[])
{
    ...
    printf( "<table>\n"
            ...
            "<tr><td>&nbsp;</td><td><input type=\"submit\" name=\"submit\" value=\"Go, mofo\"></td></tr>\n"
            "</table></form>\n", p1, p2);
    ...
    if (    0 == strlen(xcgi_param_value_named("p1")) 
        ...
        printf("<img src=\"forktest_plot.cgi?p1=%d&p2=%d\" alt=\"Image.\">\n", p1, p2);
    }
