...
int iPower;
char szCategory[100]        = "Very anxious";
int seed = 0;
...
#include "simplerand2_results2_c.c"
/*
void printresults10times() {
    ...
    nrand = iNrandRec;
    printf("iNrandRec: %d, iNrandUnrec: %d", iNrandRec, iNrandUnrec);
        
    printf("FORM_REC10: %d, iFormSubmitted: %d", FORM_REC10, iFormSubmitted);
...
"%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d",
                seed,
                iFormSubmitted, nrand2, iPercent, nranda2, nrandb2,
                fact1_1a2, fact1_1b2, fact1_2a2, fact1_2b2, fact2_1a2);
}*/
...
int main(int argc, char** argv, char* envp[])
{
    ...
    else if (0 != strlen(xcgi_param_value_named("rec10")))
        iFormSubmitted = FORM_REC10;
    else if (0 != strlen(xcgi_param_value_named("unrec10")))
        iFormSubmitted = FORM_UNREC10;
    else
        iFormSubmitted = NONE;*/
    ...
    if (FORM_UNREC10 == iFormSubmitted || FORM_REC10 == iFormSubmitted) {
        seed = atoi(xcgi_param_value_named("seed"));
        printresults10times();
        
    } else if (0 == bErr  && FORM_NONE != iFormSubmitted) {
